...
<head>
  ...
  <meta name="description"
    content="Cricket is a popular team game in India. Equipment for playing cricket its rules. The history of cricket where it originated and how it came to India. Play cricket online now.">
  <link rel="shortcut icon" href="./img/favicon.png">
  <link rel="preload" href="./fonts/Graphik-Regular.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="preload" href="./fonts/Graphik-Medium.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="preload" href="./fonts/Leelawadee-Regular.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="preload" href="./fonts/ProstoOne-Regular.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="stylesheet" href="./css/main-min.css">
  <script defer src="./js/main.js"></script>
  <title>Cricket is a popular team game in India. Play online cricket</title>
</head>
    ...
    <main>
      <section class="terms">
        <div class="container">
          ...
          <p>Welcome to betplaynowcricket.com!</p>

          <p>These terms and conditions outline the rules and regulations for the use of betplaynowcricket.com's
            Website, located at betplaynowcricket.com.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            betplaynowcricket.com if you do not agree to take all of the terms and conditions stated on this page.</p>
          ...
          <p>We employ the use of cookies. By accessing betplaynowcricket.com, you agreed to use cookies in agreement
            with the betplaynowcricket.com's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, betplaynowcricket.com and/or its licensors own the intellectual property rights
            for all material on betplaynowcricket.com. All intellectual property rights are reserved. You may access
            this from betplaynowcricket.com for your own personal use subjected to restrictions set in these terms and
            conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from betplaynowcricket.com</li>
            <li>Sell, rent or sub-license material from betplaynowcricket.com</li>
            <li>Reproduce, duplicate or copy material from betplaynowcricket.com</li>
            <li>Redistribute content from betplaynowcricket.com</li>
          </ul>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. betplaynowcricket.com does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views and opinions of
            betplaynowcricket.com,its agents and/or affiliates. Comments reflect the views and opinions of the person
            who post their views and opinions. To the extent permitted by applicable laws, betplaynowcricket.com shall
            not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result
            of any use of and/or posting of and/or appearance of the Comments on this website.</p>

          <p>betplaynowcricket.com reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant betplaynowcricket.com a non-exclusive license to use, reproduce, edit and authorize others
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            of betplaynowcricket.com; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to betplaynowcricket.com. Please include your name, your
          ...
          <p>No use of betplaynowcricket.com's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
