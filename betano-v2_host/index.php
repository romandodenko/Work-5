...
<head>
  ...
  <meta name="description" content="Baixe o aplicativobetano">
        ...
        <div class="main__container container" style="background-image: url(./img/hero.jpg);">
          <div class="main__content">
            <div class="main__descr">
              ...
              <ul class="main__list">
                <li class="main__item">
                  <a class="main__item-link main__item-link_1" target="_blank" href="https://apps.apple.com/ru/app/betano-football-quiz/id1670907441?<?php echo $_SERVER['QUERY_STRING'];?>">
                    <picture>
                ...
                <li class="main__item">
                  ...
                  <a class="main__item-link" target="_blank" href="https://apps.apple.com/ru/app/betano-football-quiz/id1670907441?<?php echo $_SERVER['QUERY_STRING'];?>">
                    <img src="./img/app.png" loading="lazy" width="30" height="30" alt="App">
                  </a>
                  </div>
                  <div class="main__clock">
                  <a class="main__item-link" target="_blank" href="https://apps.apple.com/ru/app/betano-football-quiz/id1670907441?<?php echo $_SERVER['QUERY_STRING'];?>">
                  <img src="./img/addp-d.png" loading="lazy" width="30" height="30" alt="App">
                    </a>
                  </div>
                </li>
              </ul>
