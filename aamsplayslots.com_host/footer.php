      ...
      <div class="container">
        <div class="footer__top">
          <p class="footer__text">
            ...
            Il sito non fornisce agli utenti competenze che potrebbero essere utilizzate nel gioco d'azzardo reale. I
            giochi sono disponibili per gli utenti di età superiore ai 18 anni.
          </p>
          <a class="logo logo_footer" data-da=".footer__bottom, 600, 0" href="index.php">
        ...
        <div class="footer__bottom">
          <ul class="footer__list">
            ...
            <li class="footer__item">
              <a class="footer__link" href="policy.php">
                Politica sulla riservatezza
              </a>
            </li>
            <li class="footer__item">
              <a class="footer__link" href="cookie.php">
                Gestione dei Cookie
              </a>
            </li>
          </ul>
